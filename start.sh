#!/bin/bash
export UUID=${UUID:-'abcdfe6a-f083-4591-9c03-f8d61dc3907f'} 
...
export ARGO_DOMAIN=${ARGO_DOMAIN:-'ladeny2.gyxzhao.me'}  # 固定隧道域名，留空即启用临时隧道
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiMTVkY2FkMTA3ZGVjOTVkMTQ4MGZjZmRhNzhmOWFmZWIiLCJ0IjoiZDgyOTI3NjYtZTQ5Ny00MzNhLTkzNzctMTVjYzA0ZTMxMzhiIiwicyI6Ik9EUTJZalJoTVRRdE1URTNOaTAwT0dZMUxUa3pZMlV0WlRJM01UVTNNalJqWlRobSJ9'}     # 固定json或token，留空即启用临时隧道
